...
-- ============================================
-- 7. UTILISATEUR DE TEST
-- ============================================
INSERT INTO users (id, first_name, last_name, email, password, created_at) VALUES
    (1, 'Jean', 'Dupont', 'test@example.com', '$2a$10$NkZ7nqTZw.9Xp4.kXCkYOOv7qJqYqJqYqJqYqJqYqJqYqJqYqJq', NOW());

INSERT INTO profiles (id, phone, address, city, country, user_id) VALUES
    (1, '0612345678', '123 Rue Example', 'Casablanca', 'Maroc', 1);
